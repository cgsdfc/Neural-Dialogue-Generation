local function parse_args()
    ...
    cmd:option("-readSequenceModel", true, "whether to read a pretrained seq2seq model. this variable has to be set to true when training the model")
    cmd:option("-readFutureModel", false, "whether to load a pretrained Soothsayer Model. this variable has to be set to false when training the model")
